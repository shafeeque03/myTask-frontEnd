...
function Header() {
    ...
    const handleLogout = () => {
        ...
        dispatch(userLogout());
        <Redirect to='template/my-task/react/sign-in'/>
      }
                    ...
                    <div className="h-right d-flex align-items-center order-1">
                                                ...
                                                <li className="py-2 mb-1 border-bottom">
                                                    <a href="#!" className="d-flex">
                                                        ...
                                                        <div className="flex-fill ms-2">
                                                            <p className="d-flex justify-content-between mb-0 "><span className="font-weight-bold">{user?user.firstName:'User'}</span> <small>2MIN</small></p>
                        ...
                        <Dropdown className="dropdown user-profile ms-2 ms-sm-3 d-flex align-items-center">
                            <div className="u-info me-2">
                                <p className="mb-0 text-end line-height-sm "><span className="font-weight-bold">{user?user.firstName:'User'}</span></p>
                                <small>{user?user.lastName:'User'}</small>
                            </div>
                            ...
                            <Dropdown.Menu className="rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div className="card border-0 w280">
                                    ...
                                    <div className="list-group m-2 ">
                                        ...
                                        {user?(<>
                                            <div className="list-group-item list-group-item-action border-0 "><i className="icofont-logout fs-6 me-3" onClick={handleLogout}></i>Signout</div>
                                        </>):(<>
                                            <Link to='template/my-task/react/sign-in' className="list-group-item list-group-item-action border-0 "><i className="icofont-logout fs-6 me-3" onClick={handleLogout}></i>Signout</Link>
                                        </>)}
                                        <div><hr className="dropdown-divider border-dark" /></div>
